...
public class AntColonyAlgorithm extends Distance
{
...
//                 display(Visited);
     ...
     public void getSmallestRoute()  // to find smallest rote between the Current #Route obtained and #Smallest Route till found
    {
     ...
     int getDiversification(int i)        // i= current stop
    {
        int S=-1;
        double arg_max=0;
      ...
      int getIntensification(int i)         // i is current stop
    {
